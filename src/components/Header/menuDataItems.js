...
export const menuDataItems = [
    {
        ...
        icon:<FontAwesomeIcon icon={solid("binoculars")} size="1x1" />,
        submenu: [
    ...
    { name: "Events", to: "/events", conditionality: "menuEvents", icon:<FontAwesomeIcon icon={solid("calendar-days")}  size="1x1" />, },
    {
        name: "Education and Learning",
        to: "/education-learn",
        conditionality: "menuEducationLearn",
        icon:<FontAwesomeIcon icon={solid("graduation-cap")} size="1x1" />, 
    },
    { name: "About us", to: "/about-us", conditionality: "menuAboutUs", icon:<FontAwesomeIcon icon={solid("address-card")}  size="1x1" />, },
    { name: "Contact us", to: "/contact-us", conditionality: "menuContactUs", icon:<FontAwesomeIcon icon={solid("map-pin")}  size="1x1" />, },
